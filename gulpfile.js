...
//* Следим за всеми файлами mp4,ogv,ogg,webm,avi,swf///////////////////////////////////////////////////////////////////////////////////////////////////////
function video() {
	return src('app/video/**/*.{mp4,ogv,ogg,webm,avi,swf}')
...
exports.default = series(clear, stylesLibs, scriptsLibs, styles, html, scripts, images, fonts, video, parallel(watching, browserSync));